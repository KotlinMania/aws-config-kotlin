...
This file is the quick-reference operating contract for aws-config-kotlin. The longer
...
aws-config-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`aws-config`](https://crates.io/crates/aws-config). Upstream Rust is the behavioral oracle while the
