...
kotlin {
    ...
    swiftExport {
        moduleName = "AwsConfig"
        flattenPackage = "io.github.kotlinmania.awsconfig"
    }

    android {
        namespace = "io.github.kotlinmania.awsconfig"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "aws-config-kotlin", version.toString())

    pom {
        name.set("aws-config-kotlin")
        description.set("Kotlin Multiplatform port of smithy-lang/smithy-rs - AWS SDK config and credential provider implementations")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/aws-config-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/aws-config-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/aws-config-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/aws-config-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleAwsConfigXCFramework",
    "assembleAwsConfigDebugXCFramework",
    "assembleAwsConfigReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAwsConfigXCFramework",
    "assembleReleaseIosFatFrameworkForAwsConfigXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAwsConfigXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAwsConfigXCFramework",
    "assembleDebugMacosFatFrameworkForAwsConfigXCFramework",
    "assembleReleaseMacosFatFrameworkForAwsConfigXCFramework",
    "assembleDebugTvosFatFrameworkForAwsConfigXCFramework",
    "assembleReleaseTvosFatFrameworkForAwsConfigXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAwsConfigXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAwsConfigXCFramework",
    "assembleDebugWatchosFatFrameworkForAwsConfigXCFramework",
    "assembleReleaseWatchosFatFrameworkForAwsConfigXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAwsConfigXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAwsConfigXCFramework",
