...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `AwsConfig.swiftmodule/`
...
//      `import AwsConfig` above would fail at compile time.
//
//   2. The static archive `libAwsConfig.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "AwsConfig" }` and
//      `flattenPackage = "io.github.kotlinmania.awsconfig"` configuration in
...
//      via the `AwsConfigLibrary` product.
//
